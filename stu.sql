...
INSERT INTO `Book` VALUES (1,'骆驼祥子','老舍','1993-05-06'),(2,'围城','钱钟书','1996-07-05'),(3,'呐喊','鲁迅','1989-08-08');
/*!40000 ALTER TABLE `Book` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `baidu_registration`
--

DROP TABLE IF EXISTS `baidu_registration`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `baidu_registration` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `username` char(32) NOT NULL,
  `tel` bigint(20) NOT NULL,
  `passwd` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `baidu_registration`
--

LOCK TABLES `baidu_registration` WRITE;
/*!40000 ALTER TABLE `baidu_registration` DISABLE KEYS */;
INSERT INTO `baidu_registration` VALUES (1,'hxn',12345678901,123456);
/*!40000 ALTER TABLE `baidu_registration` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `class` VALUES (1,'Hxn',9,'m',66),(2,'Hmq',10,NULL,80),(3,'lily',11,NULL,90),(4,'tony',12,NULL,99);
...
INSERT INTO `interest` VALUES (1,'Abby','sing,draw','A',8686.80,'nice');
...
INSERT INTO `marathon` VALUES (10036,'hxn','2019-06-15 12:36:50','02:48:36'),(1007,'hmq','2019-05-15 12:36:50','03:48:36'),(10038,'gqf','2018-05-06 11:36:45','02:25:56'),(10096,'nn','2019-06-17 11:26:39','02:48:36');
...
INSERT INTO `student` VALUES (1,'Abby',22,'w',86,NULL),(2,'Jame',23,'m',85,NULL),(3,'Lily',20,'m',87.5,NULL);
